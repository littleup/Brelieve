...
?>
        ...
        <header class="site-header push">Informed Consent Forms</header>
        ...
        <div id="container">
			...
			<br />
			<img src="img/thumbs/files_small.png" width="75" height="75">
			<h2> &nbsp; Informed Consent Forms</h2>
			<br />
