...
{
    // default connection
    public static $dbname = 'brelieve'; // Your database name
    public static $dbuser = 'frank'; // Your database username
    public static $dbpass = 'Trustno1$'; // // Your database password
    ...
    // editor
    public static $editor_url = 'editors/tinymce/tinymce.min.js';
    //public static $editor_url = 'https://cloud.tinymce.com/stable/tinymce.min.js'; 
    // URL path to editor script, if you want to use the visual editor.
    //public static $editor_url = 'editors/ckeditor/ckeditor.js';
    public static $editor_init_url = 'editors/tinymce_demo_init.js'; //  URL path to your custom initialization file for editor.
